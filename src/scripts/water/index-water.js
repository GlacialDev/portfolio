...
function water(expectedDiv, expectedCanvas) {
  // не отображать на мобилках и вообще на экранах меньше 768
  // и если нет соответствующего контейнера
  if(document.querySelector(expectedDiv) && window.innerWidth >= 768) {
    
    let divSelector = expectedDiv;
    let canvasSelector = expectedCanvas;
